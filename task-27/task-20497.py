...
# print(int(abs(sum(i[0] for i in edges) / 3 * 10_000)), end=' ')
# print(int(abs(sum(i[1] for i in edges) / 3 * 10_000)))

print(int(abs(sum(i[0] for i in edges) / 5 * 10_000)), end=' ')
print(int(abs(sum(i[1] for i in edges) / 5 * 10_000)))
