...
with_discount_1 = sum(i*7//10 for i in discount_1[:int(len(discount_1)*0.7)]) + sum(i*8//10 for i in discount_1[int(len(discount_1)*0.7):])
with_discount_2 = sum(i*85//100 for i in discount_2[:int(len(discount_2)*0.25)]) + sum(discount_2[int(len(discount_2)*0.25):])
